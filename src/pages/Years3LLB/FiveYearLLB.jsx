...
const FiveYearLLB = () => {
  return (
    <div className="llb-container">
      ...
      <p className="intro">
        Integrated Course: The 5-year BA LLB (Bachelor of Arts + Bachelor of Laws) is an integrated undergraduate professional degree combining arts subjects (like Political Science, Sociology, Economics, History, English, etc.) with law subjects.
      </p>
      ...
      <div className="info-grid">
        ...
        <div className="info-card">
          <h4>Duration</h4>
          <ul>
            <li>5 years, divided into 10 semesters.</li>
      ...
      <div className="curriculum">
        ...
        <div className="curriculum-grid">
          <ul>
            <li>Arts Subjects: Political Science, History, Economics, Sociology, English.</li>
            <li>Law Subjects: Constitutional Law, Contract Law, Criminal Law, Family Law, Jurisprudence, Administrative Law, International Law, Corporate Law, etc.</li>
            <li>Practical Training: Moot courts, internships, legal aid camps, seminars.</li>
          </ul>
          <ul>
            <li>Advantage: Students can directly pursue law after 12th without doing a separate graduation and then LLB.</li>
      ...
      <div className="careers">
        ...
        <div className="career-cards">
          <div className="career-card">Strong legal drafting & research ability.</div>
          <div className="career-card">Good communication & argumentation skills.</div>
          <div className="career-card">Knowledge of current laws, amendments, and legal technology (AI, e-discovery, legal databases).</div>
          <div className="career-card">Networking & internships with reputed lawyers, judges, and firms.</div>
        </div>
      </div>
...
Appear before District Courts, High Courts, and Supreme Court (after proper registration with the State Bar Council).
        ...
        <h3>Corporate & Business Sector</h3>
        <p>
          Legal Advisors, In-house Counsels, Compliance Officers in MNCs, Banks, Finance Companies, IT Companies, Startups, etc.

Corporate law, mergers, acquisitions, contracts, and intellectual property law are in high demand.
        </p>

        <h3>Law Firms</h3>
        <p>
          Join national or international law firms as an Associate.

Work involves corporate law, taxation, arbitration, mergers & acquisitions, IPR, etc.
        </p>

        <h3>Judiciary</h3>
        <p>
          Eligible to write Judicial Services Examination (Civil Judge, Judicial Magistrate, etc.).

After experience, can become a District Judge, High Court Judge, or Supreme Court Judge.
        </p>

        <h3>Government Sector</h3>
        <p>
          Opportunities in Public Prosecutor’s office, Legal Advisor to Government Departments, Law Officers in PSUs (ONGC, BHEL, LIC, etc.).
        </p>

        <h3>Higher Education & Research</h3>
        <p>
          Pursue LLM (Master of Laws) in India or abroad.

Later can go for PhD in Law and become a Professor/Lecturer in law colleges and universities.
        </p>

        <h3>Civil Services</h3>
        <p>Many BA LLB graduates prepare for UPSC, State Public Service Commission Exams (IAS, IPS, DySP, etc.).

Legal background gives an added advantage in these exams.</p>

<h3>Alternative Careers</h3>
<p>Legal Journalism, Legal Process Outsourcing (LPO), Human Rights NGOs, Policy Advocacy, International Organizations (UN, WHO, ILO), and Arbitration/Mediation specialists.</p>
      </section>
    </div>
  );
};
