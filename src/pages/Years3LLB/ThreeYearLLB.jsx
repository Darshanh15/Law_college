...
const ThreeYearLLB = () => {
  return (
    <div className="llb-container">
      <h2 className="section-title">3-Year LL.B. Program</h2>
      <p className="intro">
        The 3-Year Bachelor of Laws (LL.B.) program at <b>Bengaluru Law College</b> 
      ...
      <section className="llb-section">
        <h2 className="section-title">Job Opportunities after 3-Year LL.B.</h2>
        <p>
