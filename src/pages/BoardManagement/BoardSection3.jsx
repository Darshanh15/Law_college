...
const boardMembers = [
  {
    ...
    p3: "Bengaluru Law College is dedicated to nurturing future legal professionals with excellence in education and ethics. We empower students with knowledge, discipline, and practical skills to excel in the field of law. You know, you teach. You do not know, you learn is what we believe in. Every human is born to learn and will continue to do so over the years to come. Our Institution has attempted the first step in this endeavour.",
    img: presidentImg,
    showBio: false,
  },
  {
  ...
  {
    name: "Prof. Prasanna V Raju (LLM, MA, M.Phil)",
    role: "Managing Trustee & Treasurer Law Wings Educational Trust",
